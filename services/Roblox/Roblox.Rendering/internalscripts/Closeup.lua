...
baseUrl, characterAppearanceUrl, fileExtension, x, y, quadratic, baseHatZoom, maxHatZoom, cameraOffsetX, cameraOffsetY = %baseUrl%, %characterAppearanceUrl%, %fileExtension%, %x%, %y%, %quadratic%, %baseHatZoom%, %maxHatZoom%, %cameraOffsetX%, %cameraOffsetY%
